...
import type { Prisma, booking, bus, company, route, ticket, user } from './types';
...
interface BusSDK {
  create: <T extends Prisma.busCreateArgs, R extends CheckSelect<T, bus, Prisma.busGetPayload<T>>>(
    data: Prisma.SelectSubset<T, Prisma.busCreateArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  createMany: <T extends Prisma.busCreateManyArgs, R extends Prisma.BatchPayload>(
    args: Prisma.SelectSubset<T, Prisma.busCreateManyArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  update: <T extends Prisma.busUpdateArgs, R extends Prisma.busGetPayload<T>>(
    data: Prisma.SelectSubset<T, Prisma.busUpdateArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  updateMany: <T extends Prisma.busUpdateManyArgs, R extends Prisma.BatchPayload>(
    args: Prisma.SelectSubset<T, Prisma.busUpdateManyArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  upsert: <T extends Prisma.busUpsertArgs, R extends Prisma.busGetPayload<T>>(
    data: Prisma.SelectSubset<T, Prisma.busUpsertArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  delete: <T extends Prisma.busDeleteArgs, R extends Prisma.busGetPayload<T>>(
    data: Prisma.SelectSubset<T, Prisma.busDeleteArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  deleteMany: <T extends Prisma.busDeleteManyArgs, R extends Prisma.BatchPayload>(
    args: Prisma.SelectSubset<T, Prisma.busDeleteManyArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  findMany: <T extends Prisma.busFindManyArgs, R extends GetFindResult<Prisma.$busPayload<DefaultArgs>, T>[]>(
    args: Prisma.SelectSubset<T, Prisma.busFindManyArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  count: <T extends Prisma.busCountArgs, R extends number>(
    args: Prisma.SelectSubset<T, Prisma.busCountArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  findManyWithCount: <
    T extends Prisma.busFindManyArgs,
    R extends GetFindResult<Prisma.$busPayload<DefaultArgs>, T>[],
    C extends number,
  >(
    args: Prisma.SelectSubset<T, Prisma.busFindManyArgs>,
    options?: RequestOptions,
  ...
  findFirst: <T extends Prisma.busFindFirstArgs, R extends GetFindResult<Prisma.$busPayload<DefaultArgs>, T>>(
    args?: Prisma.SelectSubset<T, Prisma.busFindFirstArgs>,
    options?: RequestOptions,
  ) => Promise<R>;
}
...
export class RoqClient extends RoqPlatformClient {
  ...
  private initSDK() {
    ...
    this.bus = {
      create: async function createBus<
        T extends Prisma.busCreateArgs,
        R extends CheckSelect<T, bus, Prisma.busGetPayload<T>>,
      >(data: Prisma.SelectSubset<T, Prisma.busCreateArgs>, options?: RequestOptions) {
        const response = await fetcher<R, true>(
          `${ctx.endpoint}/api/model/bus/create`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'POST',
      ...
      createMany: async function createManyBus<T extends Prisma.busCreateManyArgs, R extends Prisma.BatchPayload>(
        data: Prisma.SelectSubset<T, Prisma.busCreateManyArgs>,
        options?: RequestOptions,
      ) {
        const response = await fetcher<R, false>(
          `${ctx.endpoint}/api/model/bus/createMany`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'POST',
      ...
      update: async function updateBus<T extends Prisma.busUpdateArgs, R extends Prisma.busGetPayload<T>>(
        data: Prisma.SelectSubset<T, Prisma.busUpdateArgs>,
        options?: RequestOptions,
      ) {
        const response = await fetcher<R, true>(
          `${ctx.endpoint}/api/model/bus/update`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'PUT',
      ...
      updateMany: async function updateManyBus<T extends Prisma.busUpdateManyArgs, R extends Prisma.BatchPayload>(
        data: Prisma.SelectSubset<T, Prisma.busUpdateManyArgs>,
        options?: RequestOptions,
      ) {
        const response = await fetcher<R, false>(
          `${ctx.endpoint}/api/model/bus/updateMany`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'PUT',
      ...
      upsert: async function upsertBus<T extends Prisma.busUpsertArgs, R extends Prisma.busGetPayload<T>>(
        data: Prisma.SelectSubset<T, Prisma.busUpsertArgs>,
        options?: RequestOptions,
      ) {
        const response = await fetcher<R, true>(
          `${ctx.endpoint}/api/model/bus/upsert`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'POST',
      ...
      delete: async function deleteBus<T extends Prisma.busDeleteArgs, R extends Prisma.busGetPayload<T>>(
        data: Prisma.SelectSubset<T, Prisma.busDeleteArgs>,
        options?: RequestOptions,
      ) {
        const url = `${ctx.endpoint}/api/model/bus/delete`;
        const reqUrl = makeUrl(url, data);
        const response = await fetcher<R, true>(
          reqUrl,
          {
      ...
      deleteMany: async function deleteManyBus<T extends Prisma.busDeleteManyArgs, R extends Prisma.BatchPayload>(
        data: Prisma.SelectSubset<T, Prisma.busDeleteManyArgs>,
        options?: RequestOptions,
      ) {
        const url = `${ctx.endpoint}/api/model/bus/deleteMany`;
        const reqUrl = makeUrl(url, data);
        const response = await fetcher<R, false>(
          reqUrl,
          {
      ...
      findMany: async function findManyBus<
        T extends Prisma.busFindManyArgs,
        R extends GetFindResult<Prisma.$busPayload<DefaultArgs>, T>[],
      >(args: Prisma.SelectSubset<T, Prisma.busFindManyArgs>, options?: RequestOptions) {
        const url = `${ctx.endpoint}/api/model/bus/findMany`;
        const urlWithArgs = makeUrl(url, args);
        const response = await fetcher<R, false>(
          urlWithArgs,
          {
      ...
      count: async function countBus<T extends Prisma.busCountArgs, R extends number>(
        args: Prisma.SelectSubset<T, Prisma.busCountArgs>,
        options?: RequestOptions,
      ) {
        const url = `${ctx.endpoint}/api/model/bus/count`;
        const urlWithArgs = makeUrl(url, args);
        const response = await fetcher<R, false>(
          urlWithArgs,
          {
      ...
      findManyWithCount: async function findManyWithCountBus<
        T extends Prisma.busFindManyArgs,
        R extends GetFindResult<Prisma.$busPayload<DefaultArgs>, T>[],
        C extends number,
      >(args: Prisma.SelectSubset<T, Prisma.busFindManyArgs>, options?: RequestOptions) {
      ...
      findFirst: async function findFirstBus<
        T extends Prisma.busFindFirstArgs,
        R extends GetFindResult<Prisma.$busPayload<DefaultArgs>, T>,
      >(args?: Prisma.SelectSubset<T, Prisma.busFindFirstArgs>, options?: RequestOptions) {
        const url = `${ctx.endpoint}/api/model/bus/findFirst`;
        const urlWithArgs = makeUrl(url, args);
        const response = await fetcher<R, false>(
          urlWithArgs,
          {
