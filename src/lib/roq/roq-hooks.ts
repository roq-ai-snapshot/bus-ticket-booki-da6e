...
export function useBusFindMany<
  T extends Prisma.busFindManyArgs,
  R extends GetFindResult<Prisma.$busPayload<DefaultArgs>, T>[],
>(args?: Prisma.SelectSubset<T, Prisma.busFindManyArgs>, options?: RequestOptions, swrOptions?: SWRRequestOptions<R>) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useBusFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.bus.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useBusCount<T extends Prisma.busCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.busCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useBusCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.bus.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useBusFindManyWithCount<
  T extends Prisma.busFindManyArgs,
  R extends { data: GetFindResult<Prisma.$busPayload<DefaultArgs>, T>[]; count: number },
>(args?: Prisma.SelectSubset<T, Prisma.busFindManyArgs>, options?: RequestOptions, swrOptions?: SWRRequestOptions<R>) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useBusFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.bus.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useBusFindFirst<
  T extends Prisma.busFindFirstArgs,
  R extends GetFindResult<Prisma.$busPayload<DefaultArgs>, T>,
>(args?: Prisma.SelectSubset<T, Prisma.busFindFirstArgs>, options?: RequestOptions, swrOptions?: SWRRequestOptions<R>) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useBusFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.bus.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
