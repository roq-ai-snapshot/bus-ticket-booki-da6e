...
import { useRoqPlatformUserProfiles, useRouteCount, useBusCount, useTicketCount } from 'lib/roq';
...
function DashboardPage() {
  ...
  const routeStat = useRouteCount();

  const busStat = useBusCount();
