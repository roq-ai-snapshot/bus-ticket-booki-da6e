  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the ease of travel with Bus Ticket Booking System - Your web-based portal connected to a comprehensive database, simplifying your bus ticket booking process."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxidXN8ZW58MHx8fHwxNjk4MDQ5ODk2fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the ease of travel with Bus Ticket Booking System - Your web-based portal connected to a comprehensive database, simplifying your bus ticket booking process.`}
            </Text>
            <Box
