...
import { useBusFindFirst, useRoqClient } from 'lib/roq';
...
function BusViewPage() {
  ...
  const { data, error, isLoading } = useBusFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('bus', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/buses/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Bus Number" text={data?.bus_number} />

                <FormListItem label="Capacity" text={data?.capacity} />

                <FormListItem label="Bus Model" text={data?.bus_model} />

                <FormListItem label="Bus Brand" text={data?.bus_brand} />
